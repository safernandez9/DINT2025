...
public class ComponentesAvanzados extends JFrame {
	...
	public ComponentesAvanzados() {
		...
		pnlIdentificacion.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Identificaci\u00F3n del trabajador", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		...
		pnlProvincia.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Provincia del trabajador", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		...
		JComboBox combProvincia = new JComboBox();
		...
		pnlProfesion.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Profesi\u00F3n del trabajador", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		...
		JList lstProfesion = new JList();
		scpProfesion.setViewportView(lstProfesion);
		
		JButton btnEliminarProfesion = new JButton("Eliminar profesión");
		...
		JButton btnAñadirProfesion = new JButton("Añadir profesión");
		...
		JButton btnAñadirTrabajador = new JButton("Añadir trabajador");
		...
		pnlTrabajadores.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Trabajadores disponibles", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
		...
		JScrollPane scpTrabajadores = new JScrollPane();
		...
		pnlDetalles.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "Detalle del trabajador", TitledBorder.LEADING, TitledBorder.ABOVE_TOP, null, new Color(0, 0, 0)));
